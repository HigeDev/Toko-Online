...
@section('content')
    <section class="breadcrumb-section pb-4 pb-md-4 pt-2 pt-md-2">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-6">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button href="submit" class="btn btn-first">Place Order</button>
                            </div>
                            {{ html()->form()->close() }}
                        </div>
                                                            ...
                                                            <div class="ms-3">
                                                                ...
                                                                <span>
                                                                    @if ($item->product->has_sale_price)
                                                                        <small>IDR
                                                                            {{ $item->product->sale_price_label }}</small>
                                                                        <small
                                                                            class="text-muted text-decoration-line-through">
                                                                            IDR {{ $item->product->price_label }}</small>
                                                                    @else
                                                                        <small>IDR
                                                                            {{ $item->product->price_label }}</small>
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
