                                                        ...
                                                        <span>
                                                            @if ($item->product->has_sale_price)
                                                                ...
                                                                <small class="text-muted text-decoration-line-through">
                                                                    IDR {{ $item->product->price_label }}</small>
                                                            @else
                                    ...
                                    <div class="card mb-2">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                ...
                                                <span>IDR {{ $cart->base_total_price_label }}</span>
                                            </li>
                                            <!-- list group item -->
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="me-auto">
                                                ...
                                                <span>IDR {{ $cart->discount_amount_label }}</span>
                                            </li>
                                            <!-- list group item -->
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="me-auto">
                                                ...
                                                <span class="fw-bold">IDR {{ $cart->sub_total_price_label }}</span>
                                            </li>
                                            <!-- list group item -->
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="me-auto">
                                                ...
                                                <span>IDR {{ $cart->tax_amount_label }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="d-grid mb-1 mt-4">
                                        <!-- btn -->
                                        <a class="btn btn-first btn-lg d-flex justify-content-between align-items-center"
