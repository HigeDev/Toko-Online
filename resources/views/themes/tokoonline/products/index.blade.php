                ...
                <section class="col-lg-9 col-md-12 products">
                    ...
                    <div class="row">
                        @forelse ($products as $product)
                            @include('themes.tokoonline.products.product_box', ['product' => $product])
                        @empty
